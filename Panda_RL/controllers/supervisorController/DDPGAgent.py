...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, fc3_dims, fc4_dims, fc5_dims, n_actions, name,
        ...
        self.checkpoint_file = os.path.join(chkpt_dir,name+'_pkl')
        ...
        T.nn.init.uniform_(self.q.weight.data, -f6, f6)
        T.nn.init.uniform_(self.q.bias.data, -f6, f6)
...
class DDPGAgent(object):
    def __init__(self, alpha, beta, input_dims, tau, gamma=0.99,
                 n_actions=2, max_size=1000000, layer1_size=4096,
                 layer2_size=2048, layer3_size=1024, layer4_size=512,
                 layer5_size=256, batch_size=100):
        self.gamma = gamma
        self.tau = tau
        ...
        self.actor = ActorNetwork(alpha, input_dims, layer1_size, layer2_size,
                                  layer3_size, layer4_size, layer5_size,
